...
OUTPUT_TRAIN_PATH = "music_data_train/"
OUTPUT_TEST_PATH = "music_data_test/"
...
if __name__ == "__main__":
    file_names = sorted(os.listdir(MUSIC_DATA_PATH))
    ...
    copy_subset(MUSIC_DATA_PATH, OUTPUT_TRAIN_PATH, train_file_names)
    copy_subset(MUSIC_DATA_PATH, OUTPUT_TEST_PATH, test_file_names)
